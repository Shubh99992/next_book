...
signUp3.defaultProps = {
  image1Src:
    'https://images.unsplash.com/photo-1558423039-2d4b02e50953?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcxOTE2MTg2MHw&ixlib=rb-4.0.3&q=80&w=1080',
  image1Alt: 'Sign In Image',
  action2: 'Already have an Account ? login',
  action1: 'Create Account',
  content1:
    'Join our community of best E-books for enthusiasts to unlock premium skill features.',
  heading1: 'Create an Account to Access Free E-books',
}
